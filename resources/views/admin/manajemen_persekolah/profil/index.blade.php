    ...
    <div class="mb-3 card">
        <div class="card-header-tab card-header-tab-animation card-header">
            <div class="card-header-title">
                <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"> </i> Profil {{ strtoupper($tingkat) }}
            </div>
        </div>
        ...
        <form action="{{ url('a/'.$tingkat.'/profil') }}" id="form" method="POST" hidden>
...
@section('js')
    ...
    <script>
        ...
        $('#btn-save').click(function() {
            $('#text').val(editor.container.firstChild.innerHTML);
            $('#form').submit();
        });
