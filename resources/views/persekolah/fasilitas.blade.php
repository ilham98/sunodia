...
@section('title', strtoupper($tingkat).' Sunodia ~ Fasilitas')
...
@section('content')
    <div class="container mt-3">
        <div class="card w-100" style="border-radius: 0px">
            <div class="card-body">
                <h5 class="card-title" style="background: #e3f2fd; display: inline-block; padding: 10px 20px; border-radius:30px; color: #2196f3"> Fasilitas</h5>
                <div>
                    {!! $fasilitas !!}
                </div>
            </div>
