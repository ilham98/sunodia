...
@section('title', strtoupper($tingkat).' Sunodia ~ Agenda Sekolah')
...
@section('content')
    <div class="container mt-3">
        <div class="card w-100" style="border-radius: 0px">
            <div class="card-body">
                <h5 class="card-title" style="background: #e3f2fd; display: inline-block; padding: 10px 20px; border-radius:30px; color: #2196f3"> Agenda Sekolah</h5>
                <div>
                    <div>
                        <div class="text-center">Poster Penerimaan Siswa Baru</div>
                        <img src="{{ $agenda->url_poster_penerimaan_siswa_baru }}" alt="">
                    </div>
                    <div>
                        <div class="text-center">Kalender Pendidikan</div>
                        <img src="{{ $agenda->url_kalender_pendidikan }}" alt="">
                    </div>
                    <div class="text-center mb-2">Daftar Kegiatan</div>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>No</th>
