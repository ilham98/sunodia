    ...
    <div class="container p-0 bg-white register-box mt-3">
        ...
        <form action="{{ url('registrasi/3') }}" class="p-3" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input name="asal_sekolah" type="text" class="form-control" value="{{ old('asal_sekolah') ? old('asal_sekolah') : $reg->asal_sekolah }}">
            ...
            <div class="form-group">
                ...
                <textarea name="alamat_sekolah" id="" class="form-control">{{ old('alamat_sekolah') ? old('alamat_sekolah') : $reg->alamat_sekolah }}</textarea>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <input name="nomor_ijazah" value="{{ old('nomor_ijazah') ? old('nomor_ijazah') : $reg->nomor_ijazah }}" type="text" class="form-control">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input name="lama_belajar" value="{{ old('lama_belajar') ? old('lama_belajar') : $reg->lama_belajar}}" type="text" class="form-control">
            ...
            <div class="form-group">
                ...
                <input name="jumlah_nilai_ijazah" value="{{ old('jumlah_nilai_ijazah') ? old('jumlah_nilai_ijazah') : $reg->jumlah_nilai_ijazah }}"  type="text" class="form-control">
